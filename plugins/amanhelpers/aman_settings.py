...
late_adjacent_threshold = 3 * 60  # if an aircraft is late then this is the threshold before communicating to an adjacent center
early_adjacent_threshold = 3 * 60  # if an aircraft is early, then this is the ttlg threshold before communicating to an adjacent center, make negative?
